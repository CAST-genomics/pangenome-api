...
if (process.argv.length !== 7) {
  console.error(`Error: exactly 5 arguments required, got ${process.argv.length - 2}`);
  console.error(`Usage: node generate-svg.mjs <input.json> <output.svg> <startloc> <endloc> <nodeWidthOption>`);
  process.exit(1);
}
...
create({
  ...
  hideLegend: true,
  nodeWidthOption: process.argv[6]
});
